-- Add unique constraint on user_id for service_providers table
ALTER TABLE public.service_providers
ADD CONSTRAINT service_providers_user_id_unique UNIQUE (user_id);

-- Fix the approve_provider function to use INSERT ... ON CONFLICT with the correct constraint
...
BEGIN
    ...
    -- Insert into service_providers table or update if exists
    ...
    -- Update user_profiles registration_status to approved
