-- Update the generate_standardized_provider_slots function to use provider_weekly_availability
...
BEGIN
  ...
  SELECT pwa.availability_data->date_key INTO availability_record
  ...
  -- If no availability found, return
  IF availability_record IS NULL OR NOT (availability_record->>'is_available')::boolean THEN
