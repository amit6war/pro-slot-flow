...
-- Drop user_profiles table only if it exists and recreate it properly
-- (Be careful with this in production - it will delete user data)
...
-- Create provider_services table (depends on user_profiles and subcategories)
...
BEGIN
    ...
    RAISE NOTICE 'Tables created: user_profiles, categories, subcategories, locations, provider_services';
    RAISE NOTICE 'Sample data inserted for categories, subcategories, and locations';
